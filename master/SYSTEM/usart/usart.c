...
void USART2_IRQHandler(void)                	//串口2中断服务程序
{
    ...
    static struct inf
	  ...
	  u8 head1[4]={0x06,0xC2,0x00,0x00};	
		u8 head2[7]={0x27,0xc2,0x00,0x00,0x69,0x00,0x00};
    u8 error0[3]={0xe0,0x55,0x45};
	  ...
	  u8 Res;
		...
		static u8 jiaodu[9]={0x67,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
		static u8 press[28];
		static u8 volt[32];
		extern u8 Count;
		extern u8 SleepFlag;
...
//										message.IP=memory[8];
									...
									for(k=0;k<24;k++)
									{
										volt[7+k]=ADC_origin[((u8)memory[8]-1)*24+k];
									}
									volt[31] = GetCheckSum(28,volt+4);
									Send_datatoU2(32,volt);
...
//							for(k=0;k<48;k++)
//							{
//								press[3+k]=ADC_origin[k];
//							}
//							press[51] = GetCheckSum(52,press);
//							Send_datatoU2(4,head1);
//							Send_datatoU2(52,press);
//							delay_ms(900);
//							press[2]=0x02;
//							for(k=0;k<48;k++)
//							{
//								press[3+k]=ADC_origin[k+48];
//							}
//							press[51] = GetCheckSum(52,press);
//							Send_datatoU2(4,head1);
//							Send_datatoU2(52,press);
